...
These days, I work as an agile PM on cloud security for data, analytics and AI products built on Databricks, Azure and Microsoft 365.
I'm excited by data, tech and AI and use Github for my tech learning journey. 

## Recent blog posts on [maloymanna.fr.eu.org](https://maloymanna.fr.eu.org)
- [Agentic AI: from chat to action](https://maloymanna.fr.eu.org/2025/04/07/agentic-ai-from-chat-to-action)
- [Rise of the Chinese AI dragons](https://maloymanna.fr.eu.org/2025/02/15/rise-of-the-chinese-ai-dragons)
